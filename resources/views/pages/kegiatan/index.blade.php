            ...
            <div class="panel panel-default">
                <div class="panel-head">
                    <div class="panel-title">
                        <span class="panel-title-text">Kegiatan Masjid</span>
                    </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$r->keterangan}}</td>
                                <td nowrap>
                                    <form method="POST"><a href="{{ url('kegiatan/'.Crypt::encryptString($r->id).'/edit') }}" class="btn btn-default btn-circle btn-shadow m-1" title="Edit Data"><i class="far fa-edit"></i></a>
                                        @csrf
                                        @method('DELETE')
                                        <a href="{{ url('kegiatan/'.Crypt::encryptString($r->id)) }}" id="delete_{{ $i }}" class="btn btn-danger btn-circle btn-shadow m-1 sweetalert-4" title="Hapus Data">
